...
Conv1D bank: K𝐾K=16, conv-k𝑘k-128-ReLU
...
Encoder pre-net
FC-256-ReLU →→\rightarrow Dropout(0.5) →→\rightarrow

FC-128-ReLU →→\rightarrow Dropout(0.5)
...
Conv1D bank: K𝐾K=8, conv-k-128-ReLU
...
We use r𝑟r = 2 (output layer reduction factor) for the MOS results in this paper, though larger r𝑟r values (e.g. r𝑟r = 5) also work well. We use the Adam optimizer (Kingma & Ba, 2015) with learning rate decay, which starts from 0.001 and is reduced to 0.0005, 0.0003, and 0.0001 after 500K, 1M and 2M global steps, respectively. We use a simple ℓℓ\ell1 loss for both seq2seq decoder (mel-scale spectrogram) and post-processing net (linear-scale spectrogram). The two losses have equal weights.
...
Tacotron
3.82 ±plus-or-minus\pm 0.085

Parametric
3.69 ±plus-or-minus\pm 0.109

Concatenative
4.09 ±plus-or-minus\pm 0.119
...
Sercan Arik, Mike Chrzanowski, Adam Coates, Gregory Diamos, Andrew Gibiansky,
Yongguo Kang, Xian Li, John Miller, Jonathan Raiman, Shubho Sengupta, and
Mohammad Shoeybi.
...
In Proc. Interspeech, pp. 2238–2242, 2016.
...
arXiv preprint arXiv:1610.03017, 2016.
...
In ICLR2017 workshop submission, 2017.

- Sproat & Jaitly (2016)

Richard Sproat and Navdeep Jaitly.

RNN approaches to text normalization: A challenge.

arXiv preprint arXiv:1611.00068, 2016.
...
Oriol Vinyals, Łukasz Kaiser, Terry Koo, Slav Petrov, Ilya Sutskever, and
Geoffrey Hinton.

Grammar as a foreign language.

In Advances in Neural Information Processing Systems, pp. 2773–2781, 2015.

- Wang et al. (2016)

Wenfu Wang, Shuang Xu, and Bo Xu.

First step towards end-to-end parametric TTS synthesis: Generating
spectral parameters with neural attention.

In Proceedings Interspeech, pp. 2243–2247, 2016.
...
Heiga Zen, Yannis Agiomyrgiannakis, Niels Egberts, Fergus Henderson, and
...
Generated on Mon Mar 18 00:50:48 2024 by LaTeXML
