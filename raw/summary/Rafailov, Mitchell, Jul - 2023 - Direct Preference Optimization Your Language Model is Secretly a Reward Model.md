# Rafailov, Mitchell, Jul - 2023 - Direct Preference Optimization Your Language Model is Secretly a Reward Model

## 来源信息

- 类型：论文 / 技术报告
- 原始文件：../../raw/pdfs/Rafailov, Mitchell, Jul - 2023 - Direct Preference Optimization Your Language Model is Secretly a Reward Model.pdf
- 全文文本：../../raw/text/Rafailov, Mitchell, Jul - 2023 - Direct Preference Optimization Your Language Model is Secretly a Reward Model.md
- 作者：Rafailov, Mitchell, Jul
- 年份：2023
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Rafailov, Mitchell, Jul - 2023 - Direct Preference Optimization Your Language Model is Secretly a Reward Model.md` 继续做深入整理。
