...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdfs/Pfitzmann et al. - 2022 - DocLayNet A Large Human-Annotated Dataset for Document-Layout Segmentation.pdf
- 全文文本：../../raw/text/Pfitzmann et al. - 2022 - DocLayNet A Large Human-Annotated Dataset for Document-Layout Segmentation.md
- 作者：Pfitzmann et al.
- 年份：2022
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Pfitzmann et al. - 2022 - DocLayNet A Large Human-Annotated Dataset for Document-Layout Segmentation.md` 继续做深入整理。
