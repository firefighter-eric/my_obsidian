...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdfs/Liu et al. - 2021 - Trans-Encoder Unsupervised sentence-pair modelling through self- and mutual-distillations.pdf
- 全文文本：../../raw/text/Liu et al. - 2021 - Trans-Encoder Unsupervised sentence-pair modelling through self- and mutual-distillations.md
- 作者：Liu et al.
- 年份：2021
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Liu et al. - 2021 - Trans-Encoder Unsupervised sentence-pair modelling through self- and mutual-distillations.md` 继续做深入整理。
