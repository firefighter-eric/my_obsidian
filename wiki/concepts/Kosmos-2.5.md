...
Kosmos-2.5 是 literate multimodal model 的代表之一。在当前知识库中，它表示多模态模型向文档、文字密集视觉输入延展的路线。
...
- Kosmos-2.5 把多模态能力向文档阅读和文字密集视觉理解推进。
- 在当前知识库里，它与 DocLLM、Qwen2.5-VL 一起构成文档/阅读型多模态线索。
